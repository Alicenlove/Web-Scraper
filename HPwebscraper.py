...
with open("HighPoint.csv", "w", newline='') as file:
    writer = csv.writer(file)
    writer.writerow(rowList)

# grab html for High Point chamber of commercer
#using requests librariy

url = "https://members.bhpchamber.org/list"
...
for directory in directories:
    ...
    for infobox in infoboxes:
        ...
        print(rowList)
        with open("HighPoint.csv", "a", newline='') as file:
            writer = csv.writer(file)
            writer.writerow(rowList)